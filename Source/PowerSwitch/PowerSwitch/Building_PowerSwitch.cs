...
namespace PowerSwitch
{
    ...
    public class Building_PowerSwitchMod : Building_PowerSwitch
    {
        ...
        private float radarDistance;// defined in spawn setup // the search radius for enemies (MapSize.x / 3.33)
        ...
        private int autoSwitchTimerOnTime = 6;
        private int autoSwitchTimerOffTime = 20;
        ...
        public override void ExposeData()
        {
            ...
            //Scribe_Values.Look(ref transmitsPower, "transmitsPowerActive");
            Scribe_Values.Look(ref autoSwitchOnPawnActive, "autoSwitchOnPawnActive");
            Scribe_Values.Look(ref autoSwitchOnEnemyActive, "autoSwitchOnEnemyActive");
            Scribe_Values.Look(ref autoSwitchOffEnemyActive, "autoSwitchOffEnemyActive");
            Scribe_Values.Look(ref autoSwitchTimerActive, "autoSwitchTimerActive");
            Scribe_Values.Look(ref autoSwitchTimerOnTime, "autoSwitchTimerOnTime");
            Scribe_Values.Look(ref autoSwitchTimerOffTime, "autoSwitchTimerOffTime");
            Scribe_Values.Look(ref pawnSearchModeDistanceActive, "pawnSearchModeDistanceActive");
        ...
        /// </summary>
        /// <returns></returns>
        private bool SearchForEnemy(Map map)
        {
            IEnumerable<Pawn> pawns = Radar.FindEnemyPawns(this.Position, map, radarDistance);

            return (pawns.Count() > 0);
        }
        private bool SearchForEnemyNoAnimals(Map map)
        {
            IEnumerable<Pawn> pawns = Radar.FindEnemyPawnsNoAnimals(this.Position, map, radarDistance);
        ...
        // This is a small Reflection helper
        public static class Reflect<T>
        { 
            private const System.Reflection.BindingFlags fieldBindings =
            ...
            {
                System.Reflection.FieldInfo fi = typeof(T).GetField(fieldName, fieldBindings);
